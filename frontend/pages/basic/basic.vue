<template>
  <view class="basic-info-container">
    ...
    <view class="info-section">
      ...
      <view class="form-item">
        <text class="label">体表是否有痛风石</text>
        <switch 
          :checked="basicInfo.hasTophi" 
          @change="e => basicInfo.hasTophi = e.detail.value"
          color="#42b983"
        />
      </view>
      
      <block v-if="basicInfo.hasTophi">
        <view class="form-item">
          <text class="label">出现时间</text>
          <picker 
            mode="date" 
            :value="basicInfo.tophiDate" 
            @change="e => basicInfo.tophiDate = e.detail.value"
            :end="today"
          >
            <view class="picker-value">
              <text>{{ basicInfo.tophiDate || '请选择出现时间' }}</text>
              <view class="arrow-right"></view>
            </view>
          </picker>
        </view>
        ...
        <view class="form-item">
          ...
          <input 
            class="input" 
            type="text" 
            placeholder="请输入痛风石部位" 
            v-model="basicInfo.tophiLocation"
          />
        </view>
        
        <view class="form-item">
          <text class="label">大小(cm)</text>
          <input 
            class="input" 
            type="digit" 
            placeholder="请输入痛风石大小" 
            v-model="basicInfo.tophiSize"
          />
        </view>
      </block>
      
      <view class="form-item">
        <text class="label">关节内是否有痛风石</text>
        <switch 
          :checked="basicInfo.hasJointTophi" 
          @change="e => basicInfo.hasJointTophi = e.detail.value"
          color="#42b983"
        />
      </view>
      
      <block v-if="basicInfo.hasJointTophi">
        <view class="form-item">
          <text class="label">部位</text>
          <input 
            class="input" 
            type="text" 
            placeholder="请输入关节内痛风石部位" 
            v-model="basicInfo.jointTophiLocation"
          />
        </view>
        
        <view class="form-item">
          <text class="label">活动是否受限</text>
          <switch 
            :checked="basicInfo.hasMovementLimit" 
            @change="e => basicInfo.hasMovementLimit = e.detail.value"
            color="#42b983"
          />
        </view>
      </block>
      ...
      <view class="form-item">
        <text class="label">是否行痛风石清理术</text>
        <switch 
          :checked="basicInfo.hasTophiSurgery" 
          @change="e => basicInfo.hasTophiSurgery = e.detail.value"
          color="#42b983"
        />
      </view>
      
      <block v-if="basicInfo.hasTophiSurgery">
        <view class="form-item">
          <text class="label">手术部位</text>
          <input 
            class="input" 
            type="text" 
            placeholder="请输入手术部位" 
            v-model="basicInfo.surgeryLocation"
          />
        </view>
        ...
        <view class="form-item">
          ...
          <picker 
            mode="date" 
            :value="basicInfo.surgeryDate" 
            @change="e => basicInfo.surgeryDate = e.detail.value"
            :end="today"
          >
            <view class="picker-value">
              <text>{{ basicInfo.surgeryDate || '请选择手术时间' }}</text>
              <view class="arrow-right"></view>
            </view>
          </picker>
        </view>
...
const basicInfo = reactive({
  ...
  hasJointTophi: false,
  jointTophiLocation: '',
  hasMovementLimit: false,
  hasTophiSurgery: false,
  surgeryLocation: '',
  surgeryDate: '',
  goutType: '生成过多型',
  complications: [],
